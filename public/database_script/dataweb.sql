...
INSERT INTO `course` VALUES (1,'Thiết kế phần mềm',2,4),(2,'Phân tích yêu cầu phần mềm',2,4),(3,'Nhập môn học máy',1,4),(4,'Phương pháp tính',0,4),(5,'Lý thuyết số',0,4),(6,'Nhập môn lập trình',0,4),(7,'Kỹ thuật lập trình',0,4),(8,'Lập trình ứng dụng web',2,4),(9,'Lập trình ứng dụng Java',2,4),(10,'Cơ sở trí tuệ nhân tạo',1,4),(11,'An toàn và bảo mật HTTT',3,4),(12,'Hệ quản trị CSDL',3,4);
